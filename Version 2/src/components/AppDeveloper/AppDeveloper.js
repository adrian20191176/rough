...
function AppDeveloper(){
    ...
    const [load, setStat] = useState("Tip : 99% of the people will at least have android version JellyBean ");
        ...
        <div className="imgd"style={mystyle}>
         <div className="textContainer"  >
            ...
            <form onSubmit={getText}>
             ...
             <h4 id="dialo">A Place For App Entreprneurs. Do you think you got your audience ?</h4>
             </center>
            <div className="box">
                <a><button type="submit"><i className="fa fa-search" aria-hidden="true"></i></button></a>
                <input type="text" placeholder="What's Your App?" onChange={(e) => setLink(e.target.value)}/>
            </div>
            <center>
